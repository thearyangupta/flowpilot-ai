...
<body>
  <main>
    ...
    <p>
      FlowPilot AI uses technical and organizational safeguards designed
      to protect Google user data and authentication credentials against
      unauthorized access, disclosure, alteration, or destruction.
    </p>

    <p>
      FlowPilot AI uses HTTPS/TLS to protect data transmitted between
      users and the application.
    </p>

    <p>
      Google OAuth access tokens and refresh tokens are encrypted before
      they are stored by FlowPilot AI. Authentication credentials are
      not stored as plaintext in the application database.
    </p>

    <p>
      Access to Google user data is limited to the application
      functionality required to provide the user-requested Gmail
      features. FlowPilot AI requests only the Gmail permissions required
    ...
    <p>
      FlowPilot AI retains Google user data only for as long as
      reasonably necessary to provide the user-requested functionality
      and operate the associated workflow features.
    </p>

    <p>
      FlowPilot AI may retain workflow execution records, generated
      reply draft records, approval records, connected-tool
      configuration, and related operational metadata when necessary to
      provide workflow history, debugging, security, or other
      user-facing functionality.
    </p>

    <p>
      When a user disconnects their Google account from FlowPilot AI,
      FlowPilot AI attempts to revoke the Google authorization and
      deletes the stored OAuth connection and its associated access and
      refresh credentials from the application database.
    </p>

    <p>
      Users may also request deletion of their FlowPilot account data
      and Google user data stored by FlowPilot AI by contacting
      aryangwork@gmail.com. FlowPilot AI will review and process
      deletion requests in accordance with applicable legal and
